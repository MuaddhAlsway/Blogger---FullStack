...
const navigate = useNavigate() ;
    return (
    <div onClick={() => navigate(`/blog/${_id}`)} className="w-full cursor-pointer rounded-lg  bg-white overflow-hidden shadow hover:shadow-primary/25 duration-44 shadow-md ">
