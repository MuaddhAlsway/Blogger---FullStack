  ...
  return data ? (
    <div className="relative">
      ...
      <div className="max-5 max-w-5xl md:mx-auto my-10 mt-6">
        <img src={data.image} alt className="rounded-3xl mb-5" alt="imag-blog" />

      <div className='rich-text max-w-3xl mx-auto'  dangerouslySetInnerHTML={{__html: data.description}}>

      </div>
      <div className="mt-14 mb-10 max-w-3xl mx-auto">
          <p className="font-semibold mb-4">comment ({comments_data.length})</p>
      ...
      <div className="max-w-3xl mx-auto">
            ...
            <form onSubmit={addComment} className="flex flex-col items-start gap-4 max-w-lg">
                <input onChange={(e)=>setName(e.target.value)}     value={name} type="text" placeholader='Name' required className="w-full p-2 border border-gray-300 rounded outline-none"  />
                ...
                <button type="submit" className="bg-primary text-white rounded p-2 px-8 hover: scale-102 transisiton-all cursor-pointer">Submit</button>
            </form>
      </div>
