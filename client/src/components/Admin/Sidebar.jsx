...
function Sidebar() {
  return (
    <div>
        ...
        flex items-center gap-3 py-3.5 px-3 md:min-w-64 cursor-pointer ${isActive && "bg-primary/10 border-r-4 border-primary"}
        `}>
 ...
 <NavLink  to='/admin/addBlog' className={({isActive})=> `
        ...
        `}>
         ...
         <NavLink end='true' to='/admin/comments' className={({isActive})=> `
        flex items-center gap-3 py-3.5 px-3 md:min-w-64 cursor-pointer ${isActive && "bg-primary/10 border-r-4 border-primary"}
        `}>
